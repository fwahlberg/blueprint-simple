...
export default function SlideOver({visible, hide}) {
...
//   useEffect(() => {
//     if (isOpen) {
//      setOpen(true)// Redirect to guestlists page or profile page
//     } else {
//         setOpen(false)
//     }
//   }, [isOpen]);
                      ...
                      <div className="bg-gray-700 px-4 py-6 sm:px-6">
                        ...
                        <div className="mt-1">
                          <p className="text-sm text-gray-300">
                            Get started by filling in the information below to create your new guestlist.
                          </p>
                        </div>
                      </div>
                                ...
                                <div className="relative flex items-start">
                                  ...
                                  <div className="pl-7 text-sm leading-6">
                                    ...
                                    <p id="privacy-public-description" className="text-gray-500">
                                      Everyone with the link can join the guestlist.
                                    </p>
                                  </div>
                                </div>
                                <div>
                                  <div className="relative flex items-start">
                                    ...
                                    <div className="pl-7 text-sm leading-6">
                                      ...
                                      <p id="privacy-private-description" className="text-gray-500">
                                        Only invited people can join the guestlist
                                      </p>
                                    </div>
                                  </div>
                                </div>
